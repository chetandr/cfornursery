...
class Price extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, plant', 'required'),
			array('id, plant', 'numerical', 'integerOnly'=>true),
			array('price', 'numerical'),
			array('set_date', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, plant, price, set_date', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'plant0' => array(self::BELONGS_TO, 'Plants', 'plant'),
		);
	}
	...
	public function search()
	{
		...
		return new CActiveDataProvider('Price', array(
			'criteria'=>$criteria,
		));
	}
}