...
class StockController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Stock']))
		{
			...
			if($model->save())
				$this->redirect(array('admin','plant'=>$model->plant_details->common_name));
		}
	...
	public function actionUpdate()
	{
		...
		if(isset($_POST['Stock']))
		{
			$model->attributes=$_POST['Stock'];
			if($model->save())
				$this->redirect(array('admin','Stock[plant]'=>$model->plant_details->common_name));
		}
	...
	public function loadModel()
	{
		...
		{
			if(isset($_GET['id']))
				$this->_model=Stock::model()->findbyPk($_GET['id']);
			if($this->_model===null)
